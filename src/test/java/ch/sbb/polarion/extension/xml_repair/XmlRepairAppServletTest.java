 ...
 * directory {@code src/main/resources/webapp/xml-repair-app/} and to every URL in
...
class XmlRepairAppServletTest {
    ...
    private XmlRepairAppServlet servlet;
    ...
    void setUp() throws Exception {
        ...
        servlet = new XmlRepairAppServlet();
    ...
    void servesFromTheAppWebappContext() throws Exception {
        ...
        servlet.service(requestFor("/polarion/xml-repair-app/ui/app/index.html"), response);
    ...
    void rejectsAnotherWebappContext() {
        ...
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class,
                () -> servlet.service(requestFor("/polarion/xml-repair/ui/app/index.html"), response));
