...
import static ch.sbb.polarion.extension.xml_repair.service.XmlRepairPolarionService.MSG_NOT_AUTHORIZED_BY_ADMIN;
import static ch.sbb.polarion.extension.xml_repair.service.XmlRepairPolarionService.MSG_NO_PERMISSIONS;
...
class XmlRepairPolarionServiceTest {
    ...
    void testGetRepairerMetas() {
        assertEquals(13, polarionService.getRepairerMetas(EntityType.COLLECTION).size());
        assertEquals(13, polarionService.getRepairerMetas(EntityType.DOCUMENT).size());
