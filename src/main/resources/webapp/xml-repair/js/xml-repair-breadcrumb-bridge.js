(function () {
    ...
    function isXmlRepairUrl(href) {
        return (location.hash && location.hash.indexOf(xmlRepairMarker) !== -1) || href.indexOf(xmlRepairMarker) !== -1;
    }
    ...
    const breadcrumbHtml =
        ...
        '       <img src="/polarion/xml-repair-admin/ui/images/menu/30x30/_parent.svg" class="gwt-Image" style="width: 30px; height: 30px;">' +
        '   </div>' +
