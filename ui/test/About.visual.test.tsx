    ...
    installFetchMock([
      {
        ...
        match: /\/version$/,
        json: {
          bundleName: 'XML Repair',
          bundleVendor: 'SBB',
          supportEmail: 'support@example.com',
          automaticModuleName: 'ch.sbb.polarion.extension.xml_repair',
          bundleVersion: '3.1.2',
      ...
      },
      {
        ...
        json: {
          properties: [
            { key: 'ch.sbb.xml-repair.debug', value: 'false', defaultValue: 'false', description: 'Debug logging' },
          ],
          obsoleteProperties: [],
        },
      },
      {
        ...
        json: [{ name: 'Repairers', status: 'OK', details: 'all healthy' }],
      },
      {
        method: 'GET',
        match: /\/readme$/,
        respond: () =>
          new Response('<h1>XML Repair</h1><p>Scan and repair XML issues in Polarion entities.</p>', { status: 200 }),
      },
    ]);
