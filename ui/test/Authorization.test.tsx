...
// Behavior tests for the Repair Authorization page (the React port of authorization.jsp), driven
...
const authRoutes = () => [
  ...
  {
    method: 'GET',
    match: /\/settings\/authorization\/names\/Default\/revisions\?/,
...
describe('Repair Authorization page', () => {
  ...
  it('shows revisions and reverts to a selected revision', async () => {
    ...
    const routes = [
      {
        method: 'GET',
        match: /\/settings\/authorization\/names\/Default\/content\?.*revision=4321/,
