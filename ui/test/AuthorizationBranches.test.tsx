...
// Secondary branches of the Repair Authorization page: the confirm dialogs answered with Cancel, a
...
const authRoutes = (content: unknown = { globalRoles: ['admin'], projectRoles: [] }) => [
  ...
  { method: 'GET', match: /\/settings\/authorization\/names\/Default\/content\?/, json: content },
  { method: 'PUT', match: /\/settings\/authorization\/names\/Default\/content\?/, json: {} },
  { method: 'GET', match: /\/settings\/authorization\/default-content$/, json: { globalRoles: [], projectRoles: [] } },
  { method: 'GET', match: /\/settings\/authorization\/names\/Default\/revisions\?/, json: [] },
];
...
describe('Repair Authorization selection', () => {
...
describe('Repair Authorization error reporting', () => {
  ...
  it('shows the load error when the default content cannot be read', async () => {
    ...
    await mountLoaded([
      {
        method: 'GET',
        match: /\/settings\/authorization\/default-content$/,
